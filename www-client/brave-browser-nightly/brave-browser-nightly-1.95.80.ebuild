...
SRC_URI="
	...
	arm64? ( https://github.com/brave/brave-browser/releases/download/v${PV}/${MY_PN}_${PV}_arm64.deb )
"
...
src_install() {
	...
	rm usr/share/applications/com.brave.Browser.nightly.desktop || die
